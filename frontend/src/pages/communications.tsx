...
export default function ClientCommunicationHub() {
    ...
    const { caseId, client } = router.query;
    const clientName = typeof client === 'string' && client.length > 0 ? client : '의뢰인';
    const caseLabel = typeof caseId === 'string' && caseId.length > 0 ? caseId : '사건';
                        ...
                        <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={handleSave}>
                            ...
                            <label className="flex flex-col text-sm text-gray-700 md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent"
                                    placeholder="주요 일정, 전달 사항 등을 기록하세요."
                                />
                            </label>
                            ...
                            <div className="md:col-span-2 flex justify-end">
                                <button
                                    ...
                                    className="btn-primary px-5 py-3 text-sm font-semibold disabled:opacity-60 disabled:cursor-not-allowed"
                                >
                                    정보 저장
                                </button>
                            </div>
