...
## 💼 Business & Ops (`docs/business/`, `infra/docs/`)
...
- [RUNBOOK.md](../infra/docs/RUNBOOK.md): 운영 및 장애 대응 매뉴얼

## 📘 Guides (`docs/guides/`)
- [CONTRIBUTING.md](CONTRIBUTING.md): 협업 및 코드 기여 가이드
- [TDD_GUIDE.md](guides/TDD_GUIDE.md): 테스트 주도 개발 가이드
- [CLEAN_ARCHITECTURE_GUIDE.md](guides/CLEAN_ARCHITECTURE_GUIDE.md): 아키텍처 및 패턴 가이드
- [AI_WORKER_PATTERN_GUIDE.md](guides/AI_WORKER_PATTERN_GUIDE.md): AI 워커 구현 가이드
- [claude.md](guides/claude.md): AI 에이전트 규칙
